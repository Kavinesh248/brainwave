    ...
    <Section crosses>
      <div className="container lg:flex">
        ...
        <div className="mt-4 lg:ml-auto xl:w-[38rem]">
          <p className="body-2 text-n-4 mb-4 md:mb-16 lg:mx-auto lg:mb-32 lg:w-[22rem]">
            {collabText}
          </p>

          <div className="border-n-6 relative left-1/2 flex aspect-square w-[22rem] -translate-x-1/2 scale-75 rounded-full border md:scale-100">
            ...
            <ul>
              {collabApps.map((app, index) => (
                ...
                >
                  <div
                    className={`bg-n-7 border-n-1/16 relative -rotate-${index * 45} -top-[1.6rem] flex h-[3.2rem] w-[3.2rem] rounded-xl border`}
                  >
                    <img
                      src={app.icon}
                      className="m-auto"
