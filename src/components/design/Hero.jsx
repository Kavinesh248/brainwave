...
export const BottomLine = () => {
  return (
    <>
      <div className="bg-n-6 pointer-events-none absolute top-[55.25rem] right-10 left-10 hidden h-0.25 xl:block" />
...
const Rings = () => {
  return (
    <>
      <div className="border-n-2/10 absolute top-1/2 left-1/2 aspect-square w-[65.875rem] -translate-x-1/2 -translate-y-1/2 rounded-full border" />
      ...
      <div className="border-n-2/10 absolute top-1/2 left-1/2 aspect-square w-[36.125rem] -translate-x-1/2 -translate-y-1/2 rounded-full border" />
      <div className="border-n-2/10 absolute top-1/2 left-1/2 aspect-square w-[23.125rem] -translate-x-1/2 -translate-y-1/2 rounded-full border" />
    </>
  );
};
